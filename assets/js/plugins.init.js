...
try {
    const Default = {
        defaultTabId: null,
        activeClasses: 'text-white bg-primary-600 text-white',
        inactiveClasses: 'text-muted-400 hover:text-primary-600 hover:bg-light-50',
        onShow: () => { }
    }
...
try {
    const Default = {
        alwaysOpen: false,
        activeClasses: 'bg-light-50 text-primary-600',
